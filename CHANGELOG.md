...
### [0.25.6](https://github.com/nicolasdao/neapup/compare/v0.25.5...v0.25.6) (2019-10-29)
...
* Remove uncessary log ([b6ebc11](https://github.com/nicolasdao/neapup/commit/b6ebc11))
...
* Vulnerability issues raised by github and npm ([5024801](https://github.com/nicolasdao/neapup/commit/5024801))



<a name="0.25.0"></a>
# [0.25.0](https://github.com/nicolasdao/neapup/compare/v0.24.4...v0.25.0) (2019-07-30)
...
* Add better support for displaying deployment progress in the terminal ([1043d0f](https://gitlab.com/neap/neap-manager/commit/1043d0f))
